...
if __name__ == "__main__":
    ...
    loader_dict = get_context_dataloader(split='test', batch_size=5, num_workers=0, as_tuple=False)
    ...
    loader_tuple = get_context_dataloader(split='test', batch_size=5, num_workers=0, as_tuple=True)
    ...
    loader_t = get_context_dataloader(split='test', batch_size=5, num_workers=0, transpose=True, as_tuple=True)
